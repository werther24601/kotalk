...
![Mobile onboarding](docs/assets/latest/vstalk-web-onboarding.png)

초기 진입과 가입 흐름

#### Inbox

![Mobile inbox](docs/assets/latest/vstalk-web-list.png)

현재 받은함 구조

#### Search

![Mobile search](docs/assets/latest/vstalk-web-search.png)

검색과 재발견 흐름

#### Saved

![Mobile saved](docs/assets/latest/vstalk-web-saved.png)

보관과 후속조치 허브

#### Chat

![Mobile chat](docs/assets/latest/vstalk-web-chat.png)
