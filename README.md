...
![KoTalk mark](branding/png/kotalk-transparent-256.png)
...
[![status](https://img.shields.io/badge/status-active%20alpha-166534)](PROJECT_STATUS.md)
[![platforms](https://img.shields.io/badge/platforms-windows%20%7C%20web%20%7C%20android-1D4ED8)](PROJECT_STATUS.md)
[![docs](https://img.shields.io/badge/docs-master%20plan%20%2B%20atlas-111827)](문서/README.md)
[![license](https://img.shields.io/badge/license-Apache--2.0-1F2937)](LICENSE)
[![web](https://img.shields.io/badge/live-vstalk.phy.kr-0F766E)](https://vstalk.phy.kr)
[![download](https://img.shields.io/badge/download-mirror%20live-166534)](https://download-vstalk.phy.kr)
[![verified](https://img.shields.io/badge/verified-2026--04--16-6B7280)](PROJECT_STATUS.md)

[Project Status](PROJECT_STATUS.md) · [Showcase](SHOWCASE.md) · [Background](BACKGROUND.md) · [Alternative Gap](ALTERNATIVE_GAP.md) · [Platform Strategy](CLIENT_PLATFORM_DECISION.md) · [Brand Guide](branding/BRAND_GUIDE.md) · [FAQ](FAQ.md) · [Releases](RELEASING.md) · [Trust Center](TRUST_CENTER.md) · [Architecture](ARCHITECTURE.md) · [Master Plan](문서/README.md) · [Contributing](CONTRIBUTING.md)

| Try Web | See Screens | Read Status | Get Builds |
|---|---|---|---|
| [모바일 웹 진입점](https://vstalk.phy.kr) | [최신 화면 묶음](SHOWCASE.md) | [현재 동작 범위](PROJECT_STATUS.md) | [미러와 릴리즈 경로](RELEASING.md) |

![KoTalk desktop shell](docs/assets/latest/hero-shell.png)

_플랫한 화이트 톤과 컴팩트한 창 밀도를 기준으로 정리한 현재 데스크톱 셸_
...
![Desktop shell](docs/assets/latest/hero-shell.png)
...
![Mobile web onboarding](docs/assets/latest/vstalk-web-onboarding.png)
